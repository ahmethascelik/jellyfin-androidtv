...
class OpenSubtitlesSource(val openSubtitlesClient: OpenSubtitlesClient, val userPreferences: OnlineSubtitlePreferences) : OnlineSubtitleSource {
	...
	override suspend fun fetchSubtitleList(
		...
		val preferredLanguages = userPreferences[OnlineSubtitlePreferences.openSubtitlesPreferredLanguages]
