 ...
 */
class OptionsLinkToOnlineSubtiles(
	private val context: Context
) : OptionsItemMutable<Unit>() {
	@DrawableRes
	var icon: Int? = null
	var content: String? = null
	var fragment: KClass<out LeanbackPreferenceFragmentCompat>? = null
	var extras: Bundle? = null

	inline fun <reified T : LeanbackPreferenceFragmentCompat> withFragment(extraBundle: Bundle? = null) {
		fragment = T::class
		extras = extraBundle
	}
...
@OptionsDSL
fun OptionsCategory.linkToOnlineSubtitles(init: OptionsLink.() -> Unit) {
